...
export interface ApiListeningContentListeningContent
  ...
  attributes: {
    ...
    transcript: Schema.Attribute.RichText & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSpeakingContentSpeakingContent
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    evaluationCriteria: Schema.Attribute.JSON & Schema.Attribute.Required;
    exampleResponse: Schema.Attribute.Media<'audios'>;
    examType: Schema.Attribute.Enumeration<
      ['CELPIP', 'TEF', 'GENERAL_ENGLISH']
    > &
      Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Required;
    supportingMaterials: Schema.Attribute.Media<
      'images' | 'files' | 'videos',
      true
    >;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    readingContents: Schema.Attribute.Relation<
      'manyToMany',
      'api::reading-content.reading-content'
    >;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    speakingContents: Schema.Attribute.Relation<
      'manyToMany',
      'api::speaking-content.speaking-content'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    writingContents: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiWritingContentWritingContent
  ...
  attributes: {
    ...
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    evaluationCriteria: Schema.Attribute.JSON & Schema.Attribute.Required;
    exampleResponse: Schema.Attribute.RichText;
    examType: Schema.Attribute.Enumeration<
      ['CELPIP', 'TEF', 'GENERAL_ENGLISH']
    > &
      Schema.Attribute.Required;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wordLimit: Schema.Attribute.Integer & Schema.Attribute.Required;
    writingType: Schema.Attribute.Enumeration<
      ['ESSAY', 'EMAIL', 'LETTER', 'REPORT', 'STORY', 'OPINION']
    > &
      Schema.Attribute.Required;
  };
}
